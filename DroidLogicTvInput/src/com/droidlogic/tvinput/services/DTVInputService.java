    ...
    public class DTVSessionImpl extends TvInputBaseSession
        ...
        */
        ...
        public void onSubtitleData(String json) {
            ...
            if (mCurrentChannel != null) {
                Log.d(TAG, "onSubtitleData curchannel:"+mCurrentChannel.getDisplayName());
